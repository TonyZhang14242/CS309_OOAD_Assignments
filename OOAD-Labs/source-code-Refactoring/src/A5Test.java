package src;//import static org.junit.jupiter.api.Assertions.*;
...
public class A5Test {
    ...
    @Test
    public void check_Movie_class() throws Exception {Class.forName("src.Movie");}

    @Test
    public void check_Rental_class() throws Exception {Class.forName("src.Rental");}

    @Test
    public void check_DateRange_class() throws Exception {Class.forName("src.DateRange");}

    @Test
    public void check_Price_class() throws Exception {
        Class<?> priceClass = Class.forName("src.Price");
    ...
    public void check_Price_subclass() throws Exception {
        Class<?> priceClass = Class.forName("src.Price");
        Class<?> childrensPriceClass = Class.forName("src.ChildrensPrice");
        Class<?> newReleasePriceClass = Class.forName("src.NewReleasePrice");
        Class<?> regularPriceClass = Class.forName("src.RegularPrice");
    ...
    public void check_FrequentRenterPoints() throws Exception {
        Class<?> movieClass = Class.forName("src.Movie");
        Class<?> rentalClass = Class.forName("src.Rental");
        Class<?> priceClass = Class.forName("src.Price");
